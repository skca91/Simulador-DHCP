...
public class SubRedU {
    ...
    public SubnetInfo info;
    
     public SubRedU(String cidrNotation) {
        calculate(cidrNotation);
    }
     
      public SubRedU(String address, String mask) {
       ...
       public final class SubnetInfo {
        ...
        private int low()           { return network() + 100; }
        private int high()          { return broadcast() - 100; }
    ...
    public String[] RetornarDirecciones(){
        info = this.getInfo();
